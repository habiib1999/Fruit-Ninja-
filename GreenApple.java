...
public class GreenApple extends Product implements GameObject {
...
@Override
   public void setImage() {
    	...
    	Image image2;
       	 ...
       	 File file1 = new File("./src/icons/fullGreenapple.png");
          image1 = new Image(file1.toURI().toString());
         File file2 = new File("./src/icons/lastgreenapple.png");
